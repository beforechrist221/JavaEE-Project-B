...
<main class="container">
    <section class="col-md-6 col-md-offset-3">
        <article>
            <h1>重置密码</h1>
            <form action="${ctx}/user/modifyPassword" method="post">
                <div class="input-group" style="min-width: 100%;">
                    <label for="password">请设置新的密码</label>
                    <input type="password" id="password" name="password" class="form-control input-lg" style="min-width: 100%;">
                </div>
